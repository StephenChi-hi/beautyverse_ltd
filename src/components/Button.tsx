...
const Button: React.FC<ButtonProps> = ({
  ...
  const commonClasses = `relative overflow-hidden group ${backgroundColor} ${color} ${border} ${body_Font.className} px-[24px] py-[12px] font-medium  text-[14px] sm:text-[14px] md:text-[16px] lg:text-[17px] xl:text-[18px] 2xl:text-[18px] rounded-lg- cursor-pointer text-center ${additionalClasses}`;
