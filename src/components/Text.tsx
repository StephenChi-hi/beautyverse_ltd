...
export const Paragraph1: React.FC<{
  ...
  <p
    className={`text-[14px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[19px] 2xl:text-[20px] leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px]  ${body_p_regular.className} ${className}`}
  >
    {children}
  </p>
);
...
export const Paragraph2: React.FC<{
  ...
  <p
    className={`text-[14px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[16px] 2xl:text-[16px] leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px]-   ${body_p_regular.className} ${className}`}
  >
    {children}
  </p>
);
  ...
  export const ParagraphLink1: React.FC<{
    ...
    <p
      className={`text-[14px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[19px] 2xl:text-[20px] leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px] hover:scale-105 transition-transform duration-300  ${body_Font_Regular.className} ${className}`}
    >
      {children}
    </p>
  );
   ...
   export const ParagraphLink2: React.FC<{
     ...
     <p
       className={`text-[14px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[19px] 2xl:text-[20px] leading-[24px] sm:leading-[28px] md:leading-[32px] lg:leading-[36px] xl:leading-[38px] 2xl:leading-[40px] hover:scale-105 transition-transform duration-300  ${body_Font_Light.className} ${className}`}
     >
       {children}
     </p>
   );
