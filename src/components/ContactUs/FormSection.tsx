  ...
  const SuccessPopup = () => {
    return (
      <div className="fixed inset-0 -top-[175px] -left-[100px] -right-[100px] h-screen- min-w-full flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div
          ref={successPopupRef}
          className="bg-white flex flex-col text-center gap-[24px] items-center -lg [20px] sm:px-[82px] p-[24px] sm:py-[62px] shadow-lg"
        >
          ...
          <div className="grid min-w-full  grid-cols-1 md:grid-cols-2 gap-[24px] xl:gap-[32px] mb-6 text-[14px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[19px] 2xl:text-[20px]">
            <div>
              ...
              <input
                ...
                className="w-full border -[10px] p-2 outline-none"
              ...
              <div className="flex flex-col space-y-3">
                <label className="inline-flex items-center">
                  <input
                    ...
                    value="email"
                    onChange={formik.handleChange}
                    className="form-checkbox min-h-5 min-w-5 text-orange-500 appearance-none checked:bg-primary checked:border-transparent focus:outline-none border border-primary  checked:after:content-['✓'] checked:after:text-white checked:after:text-xs checked:after:flex checked:after:justify-center"
                  />
          ...
          <div className=" space-y-[24px] xl:space-y-[32px]">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border -[10px] p-2 h-[169px] outline-none "
              />
