    ...
    <div className=" bg-bg_gray py-[70px] xl:py-[100px]">
      <div className=" container1    text-p_black" data-aos="flip-right">
        <div className=" grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div
            className=" bg-primary  h-full bg-cover bg-center py-[30px] px-4  sm:py-[100px] sm:px-[60px] flex flex-col justify-cente text-white [#95E4CF]  "
            style={{
          ...
          >
            ...
            <Paragraph1>
              Have a question about our collections or need guidance in finding
              the perfect products? Fill out the form below — our team is ready
              to help you discover beauty solutions tailored to your needs.
            </Paragraph1>
            ...
            <div className=" flex mt-8 sm:mt-[120px] flex-col gap-[30px] sm:gap-[50px] ">
              <div className=" flex gap-2 items-start">
                ...
                <div className="">
                  <Paragraph2> +2347089499666</Paragraph2>
              ...
              <div className=" flex gap-2 items-start">
                ...
                <div className="">
                  <Paragraph2> Beautyversecoltd@gmail.com</Paragraph2>
                  <Paragraph2 className=" italic ">
                    {" "}
              ...
              <div className=" flex gap-2 items-start">
                ...
                <div className="">
                  <Paragraph2> B30 kaduna plaza, BBC trade-fair,</Paragraph2>
                  <Paragraph2 className=" italic ">
                    {" "}
                    Ojo, Lagos, Nigeria
                  </Paragraph2>
